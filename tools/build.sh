#!/usr/bin/env bash
# build.sh - Compila e empacota o app Servidor de Arquivos para Tab5 OS
set -euo pipefail
...
echo "[OK] Build e empacotamento concluidos com sucesso em ${DIST_DIR}/com.tab5.fileserver.tab5pkg"
